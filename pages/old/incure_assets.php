...
<?php   include ("../pages/side.php");?>        
		...
		<form  method="post" action="save_incure_assets.php"  role="form">
		   ...
		   <table class="table table-bordered table-hover">
				...
				<tbody class="detail">
                		<tr> 
                            <td>
                            <?php 
							    $query="select * from balance_sheet order by balance_sheet_type ASC";
                                $query_run=mysqli_query($con,$query);
                                echo "<select id='' name='balance_sheet_type' class='form-control js-example-basic-single'>";
                                    while($result=mysqli_fetch_assoc($query_run)){
										$balance_sheet_type=$result['balance_sheet_type'];
										echo "<option>$balance_sheet_type</option>";
                                    }
                                echo "</select>";
                            ?>
                            </td>
