                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
								...
								<?php
										$query="select * from user";$query = mysqli_query($con,"select * from item_stock inner join items on item_stock.ITEM_ID=items.ITEM_ID") or die(mysqli_error($con));
										$total_quantity=0;
									  ...
									  function drawChart() {
										...
										var data = google.visualization.arrayToDataTable([
										  ['Task', 'Hours per Day'],
											...
											echo "['".$a['EXPENSE_NAME']."',".$a['AMOUNT_SPENT']."],";
