	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				...
				<form id="form1" runat="server" method="post" action="add_sales.php" role="form">
				<div class="box box-primary">
					<div class="box-header"><h3 class="box-title">Select Customer</h3></div>
					<div class="row">
						<div class = "col-md-4">
							<div class="form-group"><?php  selection('customer','customer_name','No Customer');   ?></div>		
						</div>
						<div class = "col-md-4">
...
<script type="text/javascript">
	...
	var customers_select = document.getElementById("customers_select");
	function show_Customer_Balance(){
		b.innerHTML = "Balance : "+customer_balance.length;
	}
</script>
