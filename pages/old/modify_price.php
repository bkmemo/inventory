...
<body>
 ...
 <?php   include ("../pages/side.php");?>
        ...
        <div id="page-wrapper">
        	...
        	<div class="row">
           		<form id="form1" runat="server" method="post" action="modify_price.php" role="form">
            ...
            <div class="row">
                <div class="col-lg-12">
<?php
			$query0="select * from item_retailprice inner join items on item_retailprice.item_id = items.ITEM_ID";
			$query_run0=mysqli_query($con,$query0);
			$rows0=mysqli_num_rows($query_run0);
			$query="select * from item_retailprice inner join items on item_retailprice.item_id = items.ITEM_ID order by ITEM_NAME limit 0,10";
			if(isset($_POST['limit_view'])){
				$number_of_results = $_POST['number_of_results'];
				if($number_of_results=='All'){
					$query="select * from item_retailprice inner join items on item_retailprice.item_id = items.ITEM_ID order by ITEM_NAME ";
				}
				else{
					$query="select * from item_retailprice inner join items on item_retailprice.item_id = items.ITEM_ID order by ITEM_NAME  limit 0,$number_of_results";
				}
			}
	        ...
	        echo "	<div class='dataTable_wrapper'>
			 <table class='table table-striped table-bordered table-hover' id='dataTables-example'>
			    <thead>
		            <tr class='success' align='center'><td style='text-align:left;'>Item</td><td style='text-align:left;'>Retail price</td><td>Modify</td></tr>
			    </thead>";
				$no_of_items=0;
			while($a=mysqli_fetch_assoc($query_run)){
				...
				<td><a href='edit_price.php?item_id=$item_id' class='btn btn-success'>Modify</a></td>
				</tr></tbody>";
			}
			echo "</table><br>";
