		   ...
		   ?>
              ...
              <div class="row">
                <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                         Phone Return Status
                		<select type="text"  name="phone_return_status"  class="form-control" />
									<option>Normal Phone</option>
									<option>Faulty</option>
						</select>
                     </div>
					 <div class="col-md-4">
                         Faulty Description:
                		<textarea type="text"  name="faulty_description"  class="form-control"/></textarea>
                     </div>
                     <div class="col-md-4">
                    Date Of Sale:
