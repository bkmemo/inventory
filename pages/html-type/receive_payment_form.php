                ...
                while($a=mysqli_fetch_assoc($query_run)){
					...
					if($balance>0){
						echo "<tr>";
							...
							echo "</form>";
							echo "<td><button data-toggle='modal' data-target='#view-modal' style='float:right;' data-id='$sale_id' id='getsales_details' class='btn btn-sm btn-info'><i class='glyphicon'></i>Details</button></td>";
						echo "</tr>";
