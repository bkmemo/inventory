...
<?php   include ("../pages/side.php");?>        
		...
		<div class="col-lg-12">
            ...
            <div class="row">
				...
				<div class="panel panel-red">
				  <div class="panel-heading"><h3>Add Stock</h3></div>
		...
		<form  method="post" action="save_stock.php"  role="form" onsubmit="return checkForm(this)";>
		<br>
		<div class="col-lg-12">
		<div class="col-md-4">
		<input type="hidden" value="<?php echo $_SESSION['supplier_name']; ?>" name="supplier_name" />		
			...
			<div class="form-group">
			    <input style="" type="text" class="form-control" value=""  name="receipt_no">
			 </div>
		</div>
		<div class="col-md-4">
		 Phone Condition
                	<div class="form-group"> 	 	
            			<select type="text" type="text"  name="phone_condition"  required="required" class="form-control">
						<option value="">Select Unit</option>
						<option>New Phone</option>
						<option>Uk Used Phone</option>
						</select>
                  	</div>	 
...
var checkForm = function(form) {
  ...
  if(form_being_submitted) {
    ...
    alert("Please enter receipt_no");
    form.receipt_no.focus();
    return false;
  }
